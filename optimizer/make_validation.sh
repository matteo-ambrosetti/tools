...
#python validation.py -m water -uat -ifp examples/water/out_w1.0_int0.0-1.0_2/ -ifg ../../bulk_polar_mu_qm/xyz_water_tip3p/ -ifl ../../bulk_polar_mu_qm/com_water_tip3p_polar/ &
...
# Methanol
#python validation.py -m methanol -uat -ifp examples/methanol/out_w1.0_over_r_int0.0-1.0_1/ -ifg ../../bulk_polar_mu_qm/xyz_methanol_chelpg/ -ifl ../../bulk_polar_mu_qm/com_methanol_chelpg_polar/ &
python validation.py -m methanol -ifp examples/methanol/out_w1.0_over_r_int0.0-1.0_no_at_3/ -ifg ../../bulk_polar_mu_qm/xyz_methanol_chelpg/ -ifl ../../bulk_polar_mu_qm/com_methanol_chelpg_polar/ &
